...
```
                 ┌─────────────────────── 单次前向 ──────────────────────────────┐
  state ────────►│ <state> …  │ <q> 哪个团队? <opt>billing</opt><opt>shipping</opt> <decide> │──► {billing: 0.91, shipping: 0.09}, confidence 0.86
...
|---|---|---|---|---|---|---|---|---|
| overall | 1000 | 提示输出 JSON（generate） | 0.621 (0% 格式错误) | — | — | — | — | — |
...
| noul | 250 | 提示输出 JSON（generate） | 0.624 (0% 格式错误) | — | — | — | — | — |
...
| choice | 500 | 提示输出 JSON（generate） | 0.764 (0% 格式错误) | — | — | — | — | — |
...
| score | 250 | 提示输出 JSON（generate） | 0.332 (0% 格式错误) | — | — | — | — | — |
